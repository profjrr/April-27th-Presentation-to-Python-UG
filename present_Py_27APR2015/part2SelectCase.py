...
def testCaseSelects():
# run1 ###
    c1 = 'ten' ## test case#1 -- supply a literal 'ten'
    ## and then print(10)
    c2 = 'z'   ## test case#2 -- supply a lowercase 'z'
    ## and then print c2 is lowercase!
    c3 = 'A'   ## test case#3 -- supply an UPPERCASE 'A'
    ## and then print c3 is UPPERCASE!
    ##
## run2 ###   
##    c1 = 'zero' # default exercised!!!
##    c2 = '%' # default exercised!!!
##    c3 = '%' # default exercised!!!
### run3 ###
##    c1 = 'one'
##    c2 = 'X'
##    c3 = 'y'
